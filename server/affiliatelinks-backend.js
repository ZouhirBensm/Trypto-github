...
affiliateLinks_app_router.get('/two', (req,res)=>{
  res.redirect('https://44b61e35k2x3ry1onmodm0qntz.hop.clickbank.net');
})

// https://bidblock.ca/ral/three
affiliateLinks_app_router.get('/three', (req,res)=>{
  res.redirect('https://ecd8a0x2t1ucoz1o0ackl3qp1a.hop.clickbank.net');
})
...
affiliateLinks_app_router.get('/four', (req,res)=>{
  res.redirect('https://0ffac9yclat0r206j8yels0zew.hop.clickbank.net');
})
