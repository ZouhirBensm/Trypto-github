...
module.exports = async (req,res, next) =>{
  ...
  let hextouseforsending = res.locals.hexforpasswordreset_ifany || res.locals.ret_hexforpasswordreset_save
