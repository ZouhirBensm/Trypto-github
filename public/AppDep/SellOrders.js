        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch('http://localhost:3000/data/sellordersdata');
              ...
              case 5:
                data = _context.sent;
                objSellOrders = repairData(data); // .then(response => response.json())
                // .then(data => {
...
function SellOrderTable(props) {
  ...
  }, /*#__PURE__*/_react.default.createElement("thead", null, /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("th", null, "Order _id"), /*#__PURE__*/_react.default.createElement("th", null, "Posted by"), /*#__PURE__*/_react.default.createElement("th", null, "Date Posted"), /*#__PURE__*/_react.default.createElement("th", null, "Crypto"), /*#__PURE__*/_react.default.createElement("th", null, "Min Amount"), /*#__PURE__*/_react.default.createElement("th", null, "Max Amount"), /*#__PURE__*/_react.default.createElement("th", null, "Price"), /*#__PURE__*/_react.default.createElement("th", null, "Expiry date"), /*#__PURE__*/_react.default.createElement("th", null, "Expiry time"), /*#__PURE__*/_react.default.createElement("th", null, "Payment"))), /*#__PURE__*/_react.default.createElement("tbody", null, sellordersRow));
}

function SellOrderRow(props) {
  var sellorder = props.sellorder;
  return /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, sellorder._id), /*#__PURE__*/_react.default.createElement("td", null, sellorder.userid.email), /*#__PURE__*/_react.default.createElement("td", null, sellorder.postedDate), /*#__PURE__*/_react.default.createElement("td", null, sellorder.crypto), /*#__PURE__*/_react.default.createElement("td", null, sellorder.minamount), /*#__PURE__*/_react.default.createElement("td", null, sellorder.maxamount), /*#__PURE__*/_react.default.createElement("td", null, sellorder.price), /*#__PURE__*/_react.default.createElement("td", null, sellorder.expirydate), /*#__PURE__*/_react.default.createElement("td", null, sellorder.expirytime), /*#__PURE__*/_react.default.createElement("td", null, sellorder.payment));
}