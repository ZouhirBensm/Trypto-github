...
var MatcheRow = /*#__PURE__*/function (_Component) {
  ...
  _createClass(MatcheRow, [{
    ...
    value: function render() {
      var order = this.props.order; //console.log('here', order)
