...
class SettingsNavigator extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <BrowserRouter>
          <Link to={`/operations/set-settings/set-users-associated-locality?comprehensiveSelectedUserInfo=${JSON.stringify(this.props.comprehensiveSelectedUserInfoDataObj)}`}>Set Users Associated Locality</Link> <br />
