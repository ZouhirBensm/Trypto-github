...
class SearchEngine extends React.Component {
  ...
  render() {
    ...
    // TODO add more precise location to the currency app, and save it in db per orders
    // TODO then complete search engine capabilities in the currency app after locality is integrated
